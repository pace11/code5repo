...
<div class="col-xs-12">
  <div class="box box-danger">
    <div class="box-header with-border">
      <h3 class="box-title"><b>REGISTER</b> | List</h3>
        ...
        <tbody>
          ...
          ?>
            <tr>
              ...
              <td><?php echo $data['desc_ta']; ?></td>
              <td><?php echo $data['desc_metode']; ?></td>
              <td>
                <a href="?tampil=registerlist_edit&id=<?php echo $data['id_reg']; ?>" class="btn btn-primary btn-xs" title="edit">
                        <span class="fa fa-edit" aria-hidden="true"></span></a>
                 <a href="javascript:;" data-id="<?php echo $data['id_reg'] ?>" data-toggle="modal" data-target="#registerlist_hapus"
        ...
        <div class="modal-content">
            ...
            class="form-horizontal">
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8">
                    <input type="text" class="form-control" name="kata_kunci" autocomplete="off" placeholder="isikan kata kunci ..." required/>
                  </div>
                </div>
    ...
    <!-- modal Hapus-->
    <div id="registerlist_hapus" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="javascript:;" class="btn btn-info" id="hapus-registerlist"><i class="glyphicon glyphicon-ok"></i> Ya</a>
